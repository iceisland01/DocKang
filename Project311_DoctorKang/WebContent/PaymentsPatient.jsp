...
<meta name="viewport" content="width=device-width, initial-scale=1">
  ...
  <meta charset="UTF-8">
	<title>ชำระเงินค่ารักษาพยาบาล</title>
</head>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light container">
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
	...
	<div class="container textside">
		...
		<h3 style="text-align:center;">ชำระเงินค่ารักษาพยาบาล</h3>
			<div class="row">
					<div class="col-md-6">	
						<fieldset class="scheduler-border">
		 <legend >ชำระค่ารักษาพยาบาล</legend> 	
					<table id="Paymedicalbills">
							<tr>
								<td>รหัสผู้ป่วย <input type="text"></td>
							</tr>
							<tr>
								<td>วันที่ชำระเงิน <input type="date"></td>
							</tr>
							<tr>
								<td>ค่าพบเเพทย์ <input type="text"></td>
							</tr>
							<tr>
								<td>ค่าใช้จ่ายอื่นๆ <input type="text"></td>
							</tr>
						</table>
