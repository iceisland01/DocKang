...
<div class="container textside" >
	<h3 style="text-align:center;">การรักษาพยาบาล</h3>
	<div class="row">
		<fieldset class="scheduler-border">
		  ...
		  <div class="col-md-6">
			<from action="#" name="frmMd" method="post">
			   <table id="Medicaltreatment">
			    ...
			    <tr>
			    	<td>รหัสผู้รักษา <input type="text"></td>
			    </tr>
			    <tr>
			    	<td>รหัสผู้ป่วย <input type="text"></td>
			    </tr>
			    <tr>
			    	<td>น้ำหนัก <input type="text"></td>
			    </tr>
			    <tr>
			    	<td>ส่วนสูง <input type="text"></td>
			    </tr>
			    <tr>
		 ...
		 <div class="col-md-6">
		  	<table id="Medicaltreatment">
					<tr>
						<td>รหัสโรค <input type="text"></td>
					</tr>
					<tr>
						<td>อาการ <textarea name="addessMD" ></textarea></td>
					</tr>
				</table>
