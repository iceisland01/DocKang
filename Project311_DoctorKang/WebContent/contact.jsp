    ...
    <ul class="navbar-nav">
      ...
      <div class="row">
        <div class="col-md-6 textside">
          <from action="" name="frmcontact" method="post"> 
          <table class="textside1">
            <tr>
              <td><p>ชื่อ-นามสกุล(ต้องการ) <input type="text"></p></td>
            </tr>
            <tr>
              <td><p>E-mail(ต้องการ) <input type="text"></p></td>
            </tr>
            <tr>
              <td><p>เบอร์โทรติดต่อกลับ(ต้องการ) <input type="text"></p></td>
            </tr>
            <tr>
              <td><p>ติดต่อเรื่อง <input type="text"></p></td>
            </tr>
            <tr>
              <td>รายละเอียด<p><textarea cols="40" rows="10"name="details"></textarea></p></td>
            </tr>
            <tr>
              <td><input type="button" value="ส่ง"></td>
            </tr>
            </from>
          </table>
        </div>
         <div class="col-md-6 textside" style="text-align:center;">
      <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3777.256783349438!2d99.0085892142082!3d18.786706365885323!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30da255350938265%3A0x88f5a72bc204b1a7!2z4LiE4Lil4Li04LiZ4Li04LiB4LiB4Lij4Liw4LiU4Li54LiB4LmB4Lil4Liw4LiC4LmJ4Lit4Lir4Lih4Lit4LmA4LiB4LmI4LiHIOC4quC4seC4meC4m-C5iOC4suC4guC5iOC4reC4ouC4hOC4peC4tOC4meC4tOC4gQ!5e0!3m2!1sth!2sth!4v1569302951172!5m2!1sth!2sth" width="350" height="200" frameborder="0"  allowfullscreen=""></iframe>
            <p class="textside">สันป่าข่อยคลินิก (หมอเก่ง)คลินิกกระดูกและข้อ จ.เชียงใหม่ <br>ที่ตั้ง 271 ถ.เจริญเมือง ต.วัดเกต อ.เมือง จ.เชียงใหม่ 50000<br>โทร. 081-5303666, 053-266725<br>
            เวลาทำการจันทร์-ศุกร์ เวลา 17:00-19:00 น.<br>เสาร์-อาทิตย์ เวลา 09:00-12:00 น.<br>
            <br><br>
            Sanpakoi Clinic (Doctor Keng) <br>
              271, Cha Roen Muang Road, Tambon Watket, Muang District, Chiang Mai, Thailand<br>
            Tel. +6681-5303666, +6653-266725</p>
