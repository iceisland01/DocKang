    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item ">
		...
		<div class="container textside">
			<h3 style="text-align:center;">นัดหมาย</h3>
			<div class="row">
				<from action="#" name="frmPP" method="post">
				<fieldset class="scheduler-border">
		 <legend>รายละเอียดการนัด</legend>
				<div class="col-md-4">
					<table id="Patientappointment">
						<tr>
							<td>รหัสการนัด <input type="text"></td>
						</tr>
						<tr>
							<td>รหัสผู้ป่วย <input type="text"></td>
						</tr>
						<tr>
							<td>ชื่อผู้ป่วย <input type="text"></td>
						</tr>
						<tr>
							<td>นามสกุล <input type="text"></td>
						</tr>
						<tr>
							<td>วันนัดพบเเพเทย์ <input type="date"></td>
						</tr>
						<tr>
							<td>เวลานัด <select name="times" >
						...
						<tr>
							<td>รหัสการรักษา <input type="text"></td>
						</tr>
						<tr>
							<td>บันทึกอาการ<textarea name="addessPP" ></textarea></td>
						</tr>
					</table>
				</div>
				<div class="col-md-6">
					<fieldset class="scheduler-border">
						<table id="Patientappointment">
							<tr>
								<td>วันที่นัดหมาย <input type="date"></td>
							</tr>
							<tr>
								<td>รหัสเเพทย์ <input type="text"></td>
							</tr>
						</table>
